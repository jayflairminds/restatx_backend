...
class BudgetMaster(models.Model):
    ...
    original_loan_budget = models.IntegerField(null= True,blank=True)
    adjustments = models.IntegerField(null=True,blank=True)
    revised_budget = models.IntegerField(null= True,blank=True)
    equity_budget = models.IntegerField(null=True,blank=True)
